...
// Si nécessaire, ajoutez d'autres imports et variables ici

// Export des variables et méthodes au besoin
export { isOpen };
</script>

<style> /* Add this style block to your Vue component or CSS file */
#social {
        ...
        <div class="flex items-center">
          ...
          <div class="md:hidden" :class="{ 'block': isOpen, 'hidden': !isOpen }">
              <ul class="mt-2 space-y-2">
                  <li><a href="index" class="block px-4 py-2 text-white">Accueil</a></li>
                  <li><a href="refuges" class="block px-4 py-2 text-white">Refuges</a></li>
                  <li><a href="legislations" class="block px-4 py-2 text-white">Législations</a></li>
                  <li><a href="contact" class="block px-4 py-2 text-white">Contact</a></li>
                  <li><a class="block px-4 py-2 text-white bg-blue-500 hover:bg-blue-700 transition-colors rounded-md" href="register">S'inscrire</a></li>
              </ul>
          </div>
      </div>
    </div>
